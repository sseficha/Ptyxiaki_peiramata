import pandas as pd
import os
from pckgs.models import get_model_mlp, train_model
...
for coin in datasets:
                    ...
                    for neuron in neurons:
                        for lr in lrs:
                            for dropout in dropouts:
                                res = {}
                                path = 'pickles2/{}/mlp/{}/'.format(coin, problem)
    ...
    with open('./pickles2/{}/mlp/grouped_res.csv'.format(coin), 'a') as f:
        grouped_res.to_csv(f, header=f.tell() == 0)
                                # grouped_res.to_csv('./pickles2/{}/mlp/grouped_res.csv'.format(coin))
